  ...
  return (
    <div className="space-y-8 pb-20">
      ...
      <div className="relative group">
        <div className="h-64 sm:h-72 w-full bg-card rounded-[40px] overflow-hidden relative shadow-2xl shadow-navy/20">
          ...
          <div className="absolute top-6 sm:top-8 right-6 sm:right-10 flex flex-wrap items-center justify-end gap-3 sm:gap-4">
             <div className="hidden xs:flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-card/10 backdrop-blur-md rounded-2xl border border-border/10">
             ...
             <DropdownMenu>
                <DropdownMenuTrigger className="bg-card/10 backdrop-blur-md border border-border/10 text-primary-foreground hover:bg-card/20 h-12 w-12 rounded-2xl shadow-xl flex items-center justify-center outline-none ring-offset-primary focus-visible:ring-2 focus-visible:ring-accent transition-all">
                  <MoreHorizontal size={20} />
                </DropdownMenuTrigger>
                <DropdownMenuContent align="end" className="w-56 bg-card border-border rounded-2xl p-2 shadow-2xl">
                  <DropdownMenuGroup>
                    <DropdownMenuLabel className="text-[10px] font-black uppercase text-muted-foreground/70 tracking-widest p-3 pb-2">Account Actions</DropdownMenuLabel>
        ...
        <div className="flex flex-col sm:flex-row items-center sm:items-end gap-10 sm:gap-14 px-6 sm:px-16 -mt-12 sm:-mt-14 relative z-10 w-full">
          <div className="relative shrink-0">
            <div className="w-32 h-32 sm:w-44 sm:h-44 rounded-[40px] sm:rounded-[56px] border-[8px] border-secondary bg-card shadow-2xl overflow-hidden group-hover:scale-105 transition-transform duration-500">
               {profile?.photoURL ? (
          ...
          <div className="pb-4 space-y-4 text-center sm:text-left flex-1 min-w-0 sm:ml-4">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-start gap-4">
              ...
              <div className="flex items-center justify-center gap-3">
                ...
                <Badge variant="outline" className="sm:hidden text-[9px] font-black px-3 py-1 bg-card/100">{profile?.role === 'management' ? 'ADMIN' : 'PLAYER'}</Badge>
              </div>
            </div>
            <div className="flex flex-wrap items-center justify-center sm:justify-start gap-4 sm:gap-6 text-muted-foreground font-black text-[10px] sm:text-xs uppercase tracking-widest">
               <div className="hidden sm:flex items-center gap-2.5 bg-card px-4 py-2 rounded-2xl border border-border shadow-sm">
                 <Trophy size={14} className="text-accent" />
                 <span>{profile?.role === 'management' ? 'ADMIN' : 'PLAYER'}</span>
               </div>
               <div className="flex items-center gap-2 bg-card/40 backdrop-blur-sm sm:bg-transparent px-3 py-1.5 rounded-xl sm:p-0">
      ...
      <div className="mt-8 sm:mt-12">
        <Tabs defaultValue="account" className="w-full flex flex-col lg:flex-row-reverse gap-8 items-start">
          ...
          <TabsList className="flex flex-row lg:flex-col w-full lg:w-72 h-auto bg-card border border-border p-3 rounded-[32px] lg:sticky lg:top-8 shrink-0 overflow-x-auto lg:overflow-visible shadow-sm no-scrollbar">
          ...
          <div className="flex-1 max-w-4xl space-y-8">
            <div className="flex items-center justify-between mb-2">
              <div>
                ...
                <p className="text-sm font-bold text-muted-foreground uppercase tracking-wider">Manage your academy profile and preferences</p>
              </div>
            ...
            <TabsContent value="account" className="space-y-8 mt-0 animate-in fade-in-50 duration-500">
              ...
              <section className="bg-card border border-border rounded-3xl p-8 shadow-sm space-y-6">
                <div className="flex items-center justify-between">
                  ...
                  <Badge variant="outline" className="border-border text-[10px] font-black px-2 py-0.5">PUBLIC</Badge>
                </div>
                
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 gap-6">
                  <div className="space-y-2">
                    <Label className="text-[10px] font-black uppercase tracking-wider text-muted-foreground/60">Salutation</Label>
                    <Select value={formData.salutation} onValueChange={(v) => handleInputChange('salutation', v)}>
                      <SelectTrigger className="rounded-xl border-border focus:ring-primary h-11">
                  ...
                  <div className="md:col-span-1 space-y-2">
                    <Label className="text-[10px] font-black uppercase tracking-wider text-muted-foreground/60">First Name <span className="text-red-500">*</span></Label>
                    <Input 
                  ...
                  <div className="space-y-2">
                    <Label className="text-[10px] font-black uppercase tracking-wider text-muted-foreground/60">Middle Name</Label>
                    <Input 
                  ...
                  <div className="space-y-2">
                    <Label className="text-[10px] font-black uppercase tracking-wider text-muted-foreground/60">Last Name <span className="text-red-500">*</span></Label>
                    <Input 
                  ...
                  <div className="space-y-2">
                    <Label className="text-[10px] font-black uppercase tracking-wider text-muted-foreground/60">Father's Name</Label>
                    <Input 
                  ...
                  <div className="space-y-2">
                    <Label className="text-[10px] font-black uppercase tracking-wider text-muted-foreground/60">Mother's Name</Label>
                    <Input 
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                   <div className="space-y-2">
                    <Label className="text-[10px] font-black uppercase tracking-wider text-muted-foreground/60">Short Bio</Label>
                    <Textarea 
                      value={formData.shortBio || ''} 
                      onChange={(e) => handleInputChange('shortBio', e.target.value)}
                      className="rounded-xl border-border focus:ring-primary h-24 resize-none" 
                      placeholder="Write a brief intro..."
                    />
                  </div>
                  <div className="space-y-2">
                    <Label className="text-[10px] font-black uppercase tracking-wider text-muted-foreground/60">Long Description</Label>
                    <Textarea 
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
                  <div className="space-y-2">
                    <Label className="text-[10px] font-black uppercase tracking-wider text-muted-foreground/60">Date of Birth <span className="text-red-500">*</span></Label>
                    <Input 
                       type="date" 
                  ...
                  <div className="space-y-2">
                    <Label className="text-[10px] font-black uppercase tracking-wider text-muted-foreground/60">Gender <span className="text-red-500">*</span></Label>
                    <RadioGroup 
                  ...
                  <div className="space-y-2">
                    <Label className="text-[10px] font-black uppercase tracking-wider text-muted-foreground/60">Blood Group</Label>
                  ...
                  <div className="space-y-2">
                    <Label className="text-[10px] font-black uppercase tracking-wider text-muted-foreground/60">Religion</Label>
                    <Input 
                  ...
                  <div className="space-y-2">
                    <Label className="text-[10px] font-black uppercase tracking-wider text-muted-foreground/60">Nationality <span className="text-red-500">*</span></Label>
                  ...
                  <div className="space-y-2">
                    <Label className="text-[10px] font-black uppercase tracking-wider text-muted-foreground/60">Language <span className="text-red-500">*</span></Label>
                    <Input 
                  ...
                  <div className="space-y-2">
                    <Label className="text-[10px] font-black uppercase tracking-wider text-muted-foreground/60">Occupation</Label>
                    <Input 
              ...
              <section className="bg-card border border-border rounded-3xl p-8 shadow-sm space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6">
                  <div className="space-y-2">
                    <Label className="text-[10px] font-black uppercase tracking-wider text-muted-foreground/60">Instagram URL OR User Name</Label>
                    <div className="relative">
                      <Instagram size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground/70" />
                      <Input 
                        placeholder="https://instagram.com/ or Username" 
                        value={formData.instagram || ''} 
                        onChange={(e) => handleInputChange('instagram', e.target.value)}
                        className="pl-10 rounded-xl border-border focus:ring-primary h-11 transition-all" 
                      />
                    </div>
                  </div>
                  <div className="space-y-2">
                    <Label className="text-[10px] font-black uppercase tracking-wider text-muted-foreground/60">Facebook URL OR User Name</Label>
                    <div className="relative">
                      <Facebook size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground/70" />
                      <Input 
                        placeholder="https://facebook.com/ or Username" 
                        value={formData.facebook || ''} 
                        onChange={(e) => handleInputChange('facebook', e.target.value)}
                        className="pl-10 rounded-xl border-border focus:ring-primary h-11" 
                      />
                    </div>
                  </div>
                  <div className="space-y-2">
                    <Label className="text-[10px] font-black uppercase tracking-wider text-muted-foreground/60">X URL OR User Name</Label>
                    <div className="relative">
                      <Twitter size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground/70" />
                      <Input 
                  ...
                  <div className="space-y-2">
                    <Label className="text-[10px] font-black uppercase tracking-wider text-muted-foreground/60">LinkedIn URL OR User Name</Label>
                    <div className="relative">
                      <Linkedin size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground/70" />
                      <Input 
              ...
              <section className="bg-card border border-border rounded-3xl p-8 shadow-sm space-y-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <Label className="text-[10px] font-black uppercase tracking-wider text-muted-foreground/60">Email Address <span className="text-red-500">*</span></Label>
                    <div className="relative">
                      <Mail size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground/70" />
                      <Input 
                        disabled 
                        value={formData.email || ''} 
                        className="pl-10 rounded-xl border-border bg-secondary/30 h-11 font-bold" 
                      />
                    </div>
                  </div>
                  <div className="space-y-2">
                    <Label className="text-[10px] font-black uppercase tracking-wider text-muted-foreground/60">Phone/Mobile Number <span className="text-red-500">*</span></Label>
                    <div className="relative">
              ...
              <section className="bg-card border border-border rounded-3xl p-8 shadow-sm space-y-8">
                ...
                <div className="space-y-6">
                  <div className="space-y-2">
                    <Label className="text-[10px] font-black uppercase tracking-wider text-muted-foreground/60">Start typing your address</Label>
                    <div className="relative">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <Label className="text-[10px] font-black uppercase tracking-wider text-muted-foreground/60">Address Line 1</Label>
                      <Input 
                    ...
                    <div className="space-y-2">
                      <Label className="text-[10px] font-black uppercase tracking-wider text-muted-foreground/60">Address Line 2 (Optional)</Label>
                      <Input 
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 gap-6">
                    <div className="space-y-2">
                      <Label className="text-[10px] font-black uppercase tracking-wider text-muted-foreground/60">City <span className="text-red-500">*</span></Label>
                      <Input 
                        value={formData.city || ''} 
                    ...
                    <div className="space-y-2">
                      <Label className="text-[10px] font-black uppercase tracking-wider text-muted-foreground/60">State <span className="text-red-500">*</span></Label>
                      <Input 
                    ...
                    <div className="space-y-2">
                      <Label className="text-[10px] font-black uppercase tracking-wider text-muted-foreground/60">Country <span className="text-red-500">*</span></Label>
                      <Input 
                    ...
                    <div className="space-y-2">
                      <Label className="text-[10px] font-black uppercase tracking-wider text-muted-foreground/60">Pin / Zip code <span className="text-red-500">*</span></Label>
                      <Input 
              ...
              <section className="bg-card border border-border rounded-3xl p-8 shadow-sm space-y-6">
                <h3 className="text-lg font-black text-primary">Athlete/Player Information</h3>
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <Label className="text-[10px] font-black uppercase tracking-wider text-muted-foreground/60">Jersey Name</Label>
                      <Input 
                    ...
                    <div className="space-y-2">
                      <Label className="text-[10px] font-black uppercase tracking-wider text-muted-foreground/60">Jersey Number</Label>
                      <Input 
              ...
              <section className="bg-card border border-border rounded-3xl p-8 shadow-sm space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 gap-6">
                  <div className="space-y-2">
                    <Label className="text-[10px] font-black uppercase tracking-wider text-muted-foreground/60">Height (cm)</Label>
                    <Input 
                  ...
                  <div className="space-y-2">
                    <Label className="text-[10px] font-black uppercase tracking-wider text-muted-foreground/60">Weight (kg)</Label>
                    <Input 
                  ...
                  <div className="space-y-2">
                    <Label className="text-[10px] font-black uppercase tracking-wider text-muted-foreground/60">Handedness</Label>
                  ...
                  <div className="space-y-2">
                    <Label className="text-[10px] font-black uppercase tracking-wider text-muted-foreground/60">Physically Challenged</Label>
              ...
              <section className="bg-card border border-border rounded-3xl p-8 shadow-sm space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-6">
                  <div className="space-y-2">
                    <Label className="text-[10px] font-black uppercase tracking-wider text-muted-foreground/60">Select Your ID Proof</Label>
                  ...
                  <div className="space-y-2">
                    <Label className="text-[10px] font-black uppercase tracking-wider text-muted-foreground/60">National Identification Number</Label>
                    <Input 
                  ...
                  <div className="space-y-2">
                     <Label className="text-[10px] font-black uppercase tracking-wider text-muted-foreground/60">Upload ID Proof</Label>
                     <div className="flex items-center gap-3">
                        <Button 
                          variant="outline" 
                          className="w-full border-dashed border-2 border-border text-muted-foreground font-bold hover:bg-muted/50 h-11"
              ...
              <div className="flex items-center justify-end gap-3 pt-6">
                 <Button 
                   ...
                   className="text-muted-foreground font-black uppercase tracking-widest text-xs h-12 px-8 rounded-xl hover:bg-red-50 hover:text-red-500 transition-colors"
                 >
                   Discard Changes
                 </Button>
                 <Button 
                 ...
                 <CardContent className="p-8 space-y-6">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs font-bold text-muted-foreground uppercase">Professional Sports History</p>
                      </div>
                    </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-2">
                        <Label className="text-[10px] font-black uppercase tracking-wider text-muted-foreground/60">Previous Sports Experience</Label>
                        <Textarea 
                          value={formData.previousExperience || ''} 
                          onChange={(e) => handleInputChange('previousExperience', e.target.value)}
                          className="rounded-xl border-border focus:ring-primary min-h-[150px] resize-none" 
                 ...
                 <div className="space-y-6">
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        ...
                        <p className="text-xs text-muted-foreground font-medium">Receive match updates and approvals via email.</p>
                      </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        ...
                        <p className="text-xs text-muted-foreground font-medium">Allow other academy members to search and view your profile.</p>
                      </div>
                      <Switch defaultChecked />
                    </div>
                 </div>
               ...
               <section className="bg-card border border-border rounded-3xl p-8 shadow-sm space-y-8">
                 <div className="flex items-center gap-3">
                   ...
                   <div>
                     ...
                     <p className="text-xs font-bold text-muted-foreground uppercase">Account Access & Protection</p>
                   </div>
                 </div>
               ...
               <section className="bg-card border border-border rounded-3xl p-8 shadow-sm space-y-8">
                 <div className="flex items-center gap-3">
                   ...
                   <div>
                     ...
                     <p className="text-xs font-bold text-muted-foreground uppercase">Manage your data visibility</p>
                   </div>
                 </div>
                 ...
                 <div className="space-y-6">
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        ...
                        <p className="text-xs text-muted-foreground font-medium">Allow everyone to see your match history and stats.</p>
                      </div>
                      <Switch defaultChecked />
                    </div>
                    <Separator className="bg-secondary/50" />
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        ...
                        <p className="text-xs text-muted-foreground font-medium">Download a copy of all your data stored in the academy.</p>
                      </div>
...
function Badge({ children, variant = 'default', className }: { children: React.ReactNode, variant?: 'default' | 'outline', className?: string }) {
  return (
    <span className={cn(
      ...
      variant === 'default' ? "bg-primary text-secondary" : "border border-border bg-transparent",
      className
    )}>
      {children}
    </span>
